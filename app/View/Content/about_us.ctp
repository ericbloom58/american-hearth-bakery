                ...
                <div class="container">
                    <section id="primary" class="content-full-width">
                        ...
                        <div class="dt-sc-one-half column first">
                            <h3 class="theme-title">History of American Hearth Bakery</h3>
                            <p> <?= $about_us['Content']['content']; ?> </p>
                        </div>
                        <div class="dt-sc-one-half column">
                            <div class="corner">
                                <span class="top-right"></span>
                                <div class="border">
                                    <img src="/images/bread.jpg" alt="" title="" />
                                </div>
                ...
                <div class="container">
                    <section id="primary" class="content-full-width">
                        <div class="dt-sc-one-column column">
                            <p class="grey ribbon"> Unacceptable Ingredients</p>
                        </div>
                        <div class="margin60"></div>
                        
                        <?= $unacceptable_ingredients['Content']['content']; ?>
                        
                        <!--<div class="dt-sc-one-column column">
                            <p> Our goal is to provide the highest quality, best tasting and safest products possible at an economical price.
                                The Majority of our baked goods (although, not all) have no artificial additives, sweeteners, colorings, preservatives, or hydrogenated fats.  Our "clean label" products have a heart printed on the label and on the price list.  In addition, there are no peanuts or peanut products processed in any of our facilities.  We also, buy and use cage free/hormone free dairy and poultry ingredients.
                            </p>
                            <br><br>
                            <p> <center> Unacceptable Food Ingredients </center> </p>
